...
/* Metrics with soft skyblue background */
.stMetric {
  background: #e6f2ff;
  border-radius: 12px;
  padding: 10px;
...
/* Muted text */
.small-muted { color: #555; font-size: 0.9rem; }
</style>
...
fig_forecast_line.update_layout(title=f"{ticker} {forecast_days}-Day ARIMA Forecast (Line)",
